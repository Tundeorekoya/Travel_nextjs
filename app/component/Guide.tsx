  ...
  return (
    <section className="flexCenter flex-col">
      <div className=" padding-container max-container w-full pb-24">
        ...
        <p className="capitalize mt-1 regular-18 mb-3 text-green-50">
          we are here for you
        </p>
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          ...
          <p className="regular-16 text-gray-500 xl:max-w-[520px]">
            Only with the Cherry Bay application you will no longer get lost and
        ...
        <div className="absolute flex bg-white py-8 pl-8 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20">
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              ...
              <div className="bold-20 mt-2">Aguas Calientes</div>
            </div>
            <div className="flex w-full flex-col">
